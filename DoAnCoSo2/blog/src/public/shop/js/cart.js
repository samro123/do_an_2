    ...
    $(".add-to-cart").click(function () {
        var a = $(this); // Lấy đối tượng button mà người dùng click
        var id = a.attr("id"); // id của sản phẩm là id của button
        var name = a.attr("data-name"); // name của sản phẩm là thuộc tính data-name của button
        var price = a.attr("data-price"); // price của sản phẩm là thuộc tính data-price của button
    ...
    function displayShoppingCartItems() {
        if (sessionStorage["shopping-cart-items"] != null) {
            ...
            $.each(shoppingCartItems, function (index, item) {
                var htmlString = "";
                htmlString += "{{#each course }}";
                htmlString += "<tr>";
                htmlString += "<td class='shoping__cart__item'>" + item.name + "</td>";
                htmlString += "<td class='shoping__cart__price'>" + item.price + "</td>";
                htmlString += "<td class='shoping__cart__quantity'>" + item.quantity + "</td>";
                htmlString += "<td class='shoping__cart__total'>" + item.price*item.quantity + "</td>";
                htmlString += "</tr>";
                htmlString += " {{/each }}";
